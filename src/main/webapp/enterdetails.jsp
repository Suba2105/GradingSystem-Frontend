...
<body style="text-align:center">
	...
	<form onsubmit="enterdetails()">
		...
		<br />
		 ...
		 <input type="number" name="mark" id="num" placeholder="Enter mark" required pattern="(?=.*\d)" title="Must contain only numbers" onkeyup="validateMark()"/><span style="color:red" id="markError"></span> 
         <br /> 
	...
	if(passwordRegex.test(password))
		...
		function enterdetails() {
			...
			$.get(url, function(response) {
				...
				window.location.href = "?pageName=adminpage.jsp";
				//alert(response);
