...
<input type="text" name="password" id="password" placeholder="Enter Password"  required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter and at least 8 or more characters" onkeyup="validatePassword()"/><span style="color:red" id="passwordError"></span>
<br/><br>

<input type = "submit" value = "REGISTER" class="btn btn-success" >
&nbsp; &nbsp;
<button type="reset" class="btn btn-danger" value="clear">CLEAR</button><br/><br>
<a href="?pageName=adminlogin.jsp">Existing User</a>
